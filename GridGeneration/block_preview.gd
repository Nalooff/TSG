...
## Emitted ONLY when the mouse moves onto a new 1x1 tile
...
## Helper to force an update using cached tile data (e.g., when changing build mode, preview size, or placing a block)
